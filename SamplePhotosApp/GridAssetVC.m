...
@interface GridAssetVC () <PHPhotoLibraryChangeObserver>
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    AssetVC *assetViewController = segue.destinationViewController;
